...
//        }
        ...
        String angularHtmlPath = modulePath + "/" + "webapp/app/"+config.getModuleName()+"/" ;
        ...
        dc.setAngularControllerPath(angularHtmlPath);
        dc.setAngularModulePath(angularHtmlPath);
        dc.setAngularServicesPath(angularHtmlPath);
        return dc;
    }
